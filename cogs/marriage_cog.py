...
class MarriageView(ui.View):
    ...
    def __init__(self, proposer: discord.Member, proposed_to: discord.Member):
    ...
    async def accept_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        # Create the marriage
        marriage_cog = self.proposer.guild.get_cog("MarriageCog")
        if marriage_cog:
            success, message = await marriage_cog.create_marriage(self.proposer, self.proposed_to)
...
class MarriageCog(commands.Cog):
    ...
    async def propose_command(self, interaction: discord.Interaction, user: discord.Member):
        ...
        view = MarriageView(proposer, user)
